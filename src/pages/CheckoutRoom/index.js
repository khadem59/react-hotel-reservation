            ...
            <div className="col-md-6 p-4">
              <div className="card border-0">
                ...
                <div className="card-body px-0">
                  <h2 className="card-title ls-3">اتاق دوبلکس</h2>
                  <p className="card-text mb-0">تعداد میهمان: 2</p>
                  <p className="card-text mb-0">sq ft400 :اندازه اتاق</p>
                  <p className="card-text mb-0">قیمت/شب: 2/000/000 ریال </p>
                </div>
              </div>
            </div>
            <div className="col-md-6 p-4">
