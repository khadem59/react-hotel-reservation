...
import reservationData from "../../components/roomreservationData";
      ...
      <section className="reservation py-5">
        <div className="container">
          <div className="text-center">
            ...
            <h5>اتاق ها برای رزرو در دسترس هستند</h5>
          </div>
            ...
            <div className="card bg-white rounded overflow-hidden mt-5">
              <div className="row">
                ...
                <div className="col-md-3 text-end offset-md-1 p-3 m-auto">
                  ...
                  <Link to="/checkoutroom" className="btn btn-success rounded-0">
                    اتاق را انتخاب کنید
                  </Link>
                </div>
              </div>
